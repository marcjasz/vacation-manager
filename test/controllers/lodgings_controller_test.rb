...
class LodgingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lodging" do
    assert_difference('Lodging.count') do
      post lodgings_url, params: { lodging: { address: @lodging.address, capacity: @lodging.capacity, company: @lodging.company, email: @lodging.email, name: @lodging.name, owner: @lodging.owner, phone_number: @lodging.phone_number } }
    end
  ...
  test "should update lodging" do
    patch lodging_url(@lodging), params: { lodging: { address: @lodging.address, capacity: @lodging.capacity, company: @lodging.company, email: @lodging.email, name: @lodging.name, owner: @lodging.owner, phone_number: @lodging.phone_number } }
