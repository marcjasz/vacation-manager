...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post vacations_url, params: { vacation: { end_date: @vacation.end_date, name: @vacation.name, start_date: @vacation.start_date } }
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { end_date: @vacation.end_date, name: @vacation.name, start_date: @vacation.start_date } }
