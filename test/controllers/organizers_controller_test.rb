...
class OrganizersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organizer" do
    assert_difference('Organizer.count') do
      post organizers_url, params: { organizer: { address: @organizer.address, email: @organizer.email, name: @organizer.name, nip: @organizer.nip, phone_number: @organizer.phone_number } }
    end
  ...
  test "should update organizer" do
    patch organizer_url(@organizer), params: { organizer: { address: @organizer.address, email: @organizer.email, name: @organizer.name, nip: @organizer.nip, phone_number: @organizer.phone_number } }
