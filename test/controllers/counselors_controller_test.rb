...
class CounselorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create counselor" do
    assert_difference('Counselor.count') do
      post counselors_url, params: { counselor: { address: @counselor.address, name: @counselor.name, pesel: @counselor.pesel, phone_number: @counselor.phone_number, surname: @counselor.surname } }
    end
  ...
  test "should update counselor" do
    patch counselor_url(@counselor), params: { counselor: { address: @counselor.address, name: @counselor.name, pesel: @counselor.pesel, phone_number: @counselor.phone_number, surname: @counselor.surname } }
